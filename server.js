...
app.get("/scrape", function(req, res) {
  ...
  request("https://www.reddit.com/r/SelfDrivingCars/", function(error, response, html) {
    ...
    $("p.title").each(function(i, element) {
      ...
      result.title = $(this).children("a.may-blank").text();
      result.link = $(this).children("a.may-blank").attr("href");
